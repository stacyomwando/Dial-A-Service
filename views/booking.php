...
<head>
  <meta charset="utf-8">
    ...
    <title>Dial A Service| Booking</title>
...
<header>
  ...
  <div class="col-75">
    <div class="container">
      <form role="form" method="post" action="<?php echo base_url('bk/book'); ?>" id="cust">
        <?php $id=$_GET["id"]?>
      <input type="text" name= "bkform" value="<?php echo $id;?>" hidden>
        <div class="row">
          <div class="col-50">
           <div class="form-row">
...
<div class="form-row">
  ...
  <a href="<?php echo base_url('bk/index'); ?>"><button type="submit" class="btn btn-primary">Cancel</button></a>
</div>
</div>
