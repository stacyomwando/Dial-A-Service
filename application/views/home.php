        ...
        <div class="row">
          <div class="col-md-6 element-animate">
            <div class="media d-block media-testimonial text-center">
              <img src="<?php echo base_url();?>assets/img/person_1.jpg" alt="Image placeholder" class="img-fluid mb-3">
          ...
          <div class="col-md-6 element-animate">
            <div class="media d-block media-testimonial text-center">
               <img src="<?php echo base_url();?>assets/img/person_3.jpg" alt="Image placeholder" class="img-fluid mb-3">
