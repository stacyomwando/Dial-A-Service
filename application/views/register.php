                  ...
                  if($error_msg){
                   ...
                   ?>
                    ...
                    <div class="form-group">
                                  <input class="form-control" placeholder="Customer_Id" name="customer_id" type="text" autofocus>
                              </div>
                              <div class="form-group">
                      ...
                      <center><b>Already registered ?</b> <br></b><a href="<?php echo base_url(' Login.php'); ?>">Login here</a></center><!--for centered text-->
                  </div>
              </div>
          </div>
      </div>
