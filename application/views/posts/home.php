...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('<?php echo base_url();?>assets/Reg/img/slider-2.jpg');">
        
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1>Creating A Brighter Future</h1>
              <p>Helping you connect with people and services without great hustle..</p>
      ...
      <div class="slider-item" style="background-image: url('<?php echo base_url();?>assets/Reg/img/slider-1.jpg');">
        <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-4 col-md-6 col-12 mb-3 element-animate">
            <div class="media d-block media-feature text-center">
              ...
              <div class="media-body">
                <h3 class="mt-0 text-black">Electricians</h3>
          ...
          <div class="col-lg-4 col-md-6 col-12 mb-3 element-animate">
            <div class="media d-block media-feature text-center">
              ...
              <div class="media-body">
                <h3 class="mt-0 text-black">Plumbing</h3>
               <!--  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
 -->                <p><a href="#" class="btn btn-outline-primary btn-sm">Learn More</a></p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-12 mb-3 element-animate">
            <div class="media d-block media-feature text-center">
              ...
              <div class="media-body">
                <h3 class="mt-0 text-black">General Cleaning</h3>
               <!--  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p> -->
                <p><a href="#" class="btn btn-outline-primary btn-sm">Learn More</a></p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 element-animate">
          <div class="col-md-8 text-center mb-5">
            ...
            <p class="mb-0 lead">A word from some of our customers who have had the chance to benefit from the services we offer.</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 element-animate">
            <div class="media d-block media-testimonial text-center">
              <img src="<?php echo base_url();?>assets/Reg/img/person_1.jpg" alt="Image placeholder" class="img-fluid mb-3">
              <p>Stella Malty, <a href="#">Customer.</a></p>
              <div class="media-body">
                <blockquote>
                  <p>Dial A Service is one of the best systems I have come across. It offers a range of services that come in handy in times of need. I would definetly recommend it anytime.</p>  
                </blockquote>
          ...
          <div class="col-md-6 element-animate">
            <div class="media d-block media-testimonial text-center">
               <img src="<?php echo base_url();?>assets/Reg/img/person_3.jpg" alt="Image placeholder" class="img-fluid mb-3">
              <p>Mark Wayne, <a href="#">XYZ Inc.</a></p>
              <div class="media-body">
                <blockquote>
                  <p>Dial A Service is simply the best systems you can get offering services that are crucial to our daily life routines.</p>  
                </blockquote>
